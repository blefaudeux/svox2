...
parser.add_argument(
    ...
    type=float,
    default=None,
    help="Rendering image width (only if not --traj)",
)
parser.add_argument(
    "--height",
    "-H",
    type=float,
    default=None,
    help="Rendering image height (only if not --traj)",
)
parser.add_argument(
    "--num_views", "-N", type=int, default=600, help="Number of frames to render"
)
...
parser.add_argument(
    ...
    type=str,
    default="0,0,0",
    help="Center point to rotate around (only if not --traj)",
)
parser.add_argument(
    "--radius", type=float, default=0.85, help="Radius of orbit (only if not --traj)"
)
parser.add_argument(
    "--elevation",
    type=float,
...
parser.add_argument(
    "--vert_shift", type=float, default=0.0, help="vertical shift by up axis"
)
