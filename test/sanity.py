...
if g.use_background:
    ...
    g.background_data.data[..., :-1] = (
        torch.randn_like(g.background_data.data[..., :-1]) * 0.01
    )
...
origins = torch.tensor(
    [[-3.8992738723754883, 4.844727993011475, 4.323856830596924]], device="cuda:0"
)
dirs = torch.tensor(
    [[1.1424630880355835, -1.2679963111877441, -0.8437137603759766]], device="cuda:0"
)
